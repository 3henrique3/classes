class Reserva:
    ...
    def alterar_dias(self):
        while True:
            ...
            if opcao == 1:
                dias = int(input("Informe quantos dias deseja adicionar: "))
                self.adicionar_dias(dias)
            elif opcao == 2:
                dias = int(input("Informe quantos dias deseja reduzir: "))
                self.reduzir_dias(dias)
            elif opcao == 3:
                break
            else:
